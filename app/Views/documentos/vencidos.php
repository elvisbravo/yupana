...
<div class="row mb-4">
    <div class="col-12">
        <div>
            <h4 class="fw-bold">Documentos Vencidos</h4>
            <p class="text-muted mb-0">Documentos cuya fecha de vencimiento ha expirado</p>
        </div>
    </div>
</div>
...
<?= $this->section('scripts') ?>
    ...
    <script src="<?= base_url() ?>js/documentos_vencidos.js"></script>
<?= $this->endSection() ?>
