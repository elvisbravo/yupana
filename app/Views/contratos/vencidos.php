...
<div class="row mb-4">
    <div class="col-12">
        <div>
            <h4 class="fw-bold">Contratos Vencidos</h4>
            <p class="text-muted mb-0">Contratos cuya fecha de fin ha vencido</p>
        </div>
    </div>
</div>
...
<?= $this->section('scripts') ?>
    ...
    <script src="<?= base_url() ?>js/contratos_vencidos.js"></script>
<?= $this->endSection() ?>
