...
<div class="row mb-4">
    <div class="col-12">
        <div>
            <h4 class="fw-bold">Presentación PLE</h4>
            <p class="text-muted mb-0">Períodos cerrados pendientes de presentación PLE</p>
        </div>
    </div>
</div>
...
<?= $this->section('scripts') ?>
    ...
    <script src="<?= base_url() ?>js/periodos_ple.js"></script>
<?= $this->endSection() ?>
