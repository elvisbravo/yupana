...
<div class="row mb-4">
    <div class="col-12">
        <div>
            <h4 class="fw-bold">Cierre Mensual</h4>
            <p class="text-muted mb-0">Cierre de períodos contables abiertos o en proceso</p>
        </div>
    </div>
</div>
...
<?= $this->section('scripts') ?>
    ...
    <script src="<?= base_url() ?>js/periodos_cierre.js"></script>
<?= $this->endSection() ?>
