...
<div class="row mb-4">
    <div class="col-12 d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="text-muted mb-0">Gestión de alertas del sistema</p>
        </div>
        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#alertaModal">
            <i data-lucide="plus" class="me-1" style="width: 18px; height: 18px;"></i> Nueva Alerta
        </button>
    </div>
</div>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <table id="tablaAlertas" class="table table-striped dt-responsive align-middle mb-0">
        ...
        <div class="modal-content">
            <form id="alertaForm">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Nueva Alerta</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-2 mb-2">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select form-select-sm" name="usuario_asignado_id" id="f_asignado">
                                <option value="">Seleccionar...</option>
                    ...
                    <div class="row g-2 mb-2">
                        <div class="col-md-6">
                            <label class="form-label">Fecha Alerta <span class="text-danger">*</span></label>
                            <input type="date" class="form-control form-control-sm" name="fecha_alerta" id="f_fecha">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-2">
                        ...
                        <textarea class="form-control form-control-sm" name="mensaje" id="f_mensaje" rows="3"></textarea>
                    </div>
                </div>
