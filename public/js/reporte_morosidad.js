(function () {
    ...
    var tabla = new DataTable('#tablaMorosidad', {
        ajax: document.getElementById('listarUrl').value || '/cobros/morosidad/listar',
        responsive: true,
        order: [[9, 'desc']],
        pageLength: 25,
        ...
        columns: [
            ...
            { data: 4, className: 'text-end' }, { data: 5, className: 'text-end' },
            { data: 6, className: 'text-end' }, { data: 7 }, { data: 8 }, { data: 9 },
        ],
        language: {
