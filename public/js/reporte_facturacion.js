(function () {
    ...
    var tabla = new DataTable('#tablaFacturacion', {
        ajax: {
            url: '/reportes/facturacion/listar',
            data: function (d) { d.anio = filtroAnio.value; }
        },
        responsive: true,
        order: [[1, 'desc']],
        pageLength: 25,
    ...
    filtroAnio.addEventListener('change', function () { tabla.ajax.reload(); });
